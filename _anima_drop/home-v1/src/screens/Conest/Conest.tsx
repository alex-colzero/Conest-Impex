...
import { BillboardHighlightSection } from "./sections/BillboardHighlightSection/BillboardHighlightSection";
import { BillboardHighlightWrapperSection } from "./sections/BillboardHighlightWrapperSection/BillboardHighlightWrapperSection";
...
import { ImportantServicesSection } from "./sections/ImportantServicesSection/ImportantServicesSection";
      ...
      <div className="bg-neutral-50 overflow-hidden w-[1920px] h-[14291px] relative">
        ...
        <div className="flex flex-col w-[1419px] items-center gap-[60px] absolute top-[1081px] left-[250px]">
          ...
          <img
            ...
            alt="Logos"
            src="https://c.animaapp.com/c2XfX1Kz/img/logos.svg"
          />
        </div>
