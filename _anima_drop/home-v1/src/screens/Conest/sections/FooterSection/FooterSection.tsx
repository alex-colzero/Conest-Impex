...
export const FooterSection = (): JSX.Element => {
  const contactInfo = [
    {
      icon: "https://c.animaapp.com/c2XfX1Kz/img/solar-map-point-outline.svg",
      text: "Constanța, România",
      alt: "Solar map point",
    },
    {
      icon: "https://c.animaapp.com/c2XfX1Kz/img/solar-letter-outline.svg",
      text: "contact@conest-gaze-centrale.ro",
      alt: "Solar letter outline",
    },
    {
      icon: "https://c.animaapp.com/c2XfX1Kz/img/solar-phone-calling-outline-1.svg",
      text: "0xxx-xxx-xxx",
    ...
    {
      icon: "https://c.animaapp.com/c2XfX1Kz/img/solar-clock-circle-outline.svg",
      text: "24/7",
  ...
  const legalLinks = [
    {
      icon: "https://c.animaapp.com/c2XfX1Kz/img/la-chevron-circle-right-12.svg",
    ...
    <footer className="absolute w-[1420px] h-[363px] top-[73px] left-[250px] bg-transparent">
          ...
          {serviceAreas.map((area, index) => (
            ...
            >
              <img
                className="relative w-[18px] h-[18px]"
                alt="La chevron circle"
                src="https://c.animaapp.com/c2XfX1Kz/img/la-chevron-circle-right-12.svg"
              />
      ...
      <div className="inline-flex flex-col h-56 items-start gap-5 absolute top-[29px] left-0">
        <img
          ...
          alt="Logo"
          src="https://c.animaapp.com/c2XfX1Kz/img/logo@2x.png"
        />
