...
export const Check4 = ({ color = "#F2B821", className }) => {
  return (
    <svg
      className={`check-4 ${className}`}
      fill="none"
      height="20"
      viewBox="0 0 19 20"
      width="19"
