  ...
  return (
    <section className="flex flex-col items-center justify-center gap-5 px-5 py-[100px] relative self-stretch w-full flex-[0_0_auto] bg-[#05213c]">
      <div className="flex flex-col items-start gap-10 relative self-stretch w-full flex-[0_0_auto]">
        <h2 className="relative self-stretch mt-[-1.00px] [font-family:'Poppins',Helvetica] font-semibold text-white text-4xl tracking-[0] leading-[46.8px]">
        ...
        <div className="flex h-[488px] items-center justify-center self-stretch w-full flex-col relative">
          <div className="inline-flex flex-col items-start gap-10 relative flex-[0_0_auto]">
            {features.map((feature, index) => (
              ...
              >
                ...
                <p
                  className={`relative ${feature.width} ${index === 0 ? "h-12" : ""} [font-family:'Poppins',Helvetica] font-normal text-white text-base text-center tracking-[0.80px] leading-[normal]`}
                >
        ...
        {statistics.map((stat, index) => {
          if (stat.isMainStat) {
            return (
              <div
                key={index}
                className="inline-flex flex-col h-[185px] items-center gap-5 relative ml-[-26.00px] mr-[-26.00px]"
              >
          ...
          return (
            ...
            >
              <div className="relative w-[270px] h-[55px] mt-[-16.00px] ml-[-15.00px] mr-[-15.00px] [font-family:'Poppins',Helvetica] font-bold text-[#05213c] text-[56px] text-center tracking-[0] leading-[72.8px] whitespace-nowrap">
                {stat.number}
              </div>

              <div className="relative w-[372px] h-[23px] mb-[-12.00px] ml-[-66.00px] mr-[-66.00px] [font-family:'Poppins',Helvetica] font-medium text-[#05213c] text-base text-center tracking-[0] leading-[20.8px] whitespace-nowrap">
                {stat.label}
              </div>
            </div>
          );
