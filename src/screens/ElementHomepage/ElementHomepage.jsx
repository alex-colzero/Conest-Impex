...
const footerServices = [
  { name: "Instalații Gaze Naturale", link: "instalatii-gaze-naturale.html" },
  ...
  return (
    ...
    >
      ...
      {false && (
        ...
        >
          <div
            className={`w-full flex self-stretch items-start flex-[0_0_auto] relative ${screenWidth >= 977 && screenWidth < 1440 ? "mt-[-20.00px]" : ""} ${screenWidth >= 977 && screenWidth < 1440 ? "gap-10" : (screenWidth >= 1440) ? "gap-5" : ""} ${screenWidth >= 977 && screenWidth < 1440 ? "justify-center" : ""}`}
          >
            {screenWidth >= 977 && screenWidth < 1440 && (
              <>
                <div className="flex flex-col h-56 items-start relative flex-1 grow">
                  ...
                  <div className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto]">
                    <div className="inline-flex items-center justify-center gap-1.5 px-0 py-5 relative flex-[0_0_auto]">
                      <p className="w-[340px] font-medium text-base tracking-[0.32px] leading-[normal] relative mt-[-1.00px] [font-family:'Poppins',Helvetica] text-[#05213c]">
                ...
                <div className="flex flex-col items-start gap-10 relative flex-1 grow">
                  <div className="flex flex-col w-[293px] items-start gap-5 relative flex-[0_0_auto]">
                    ...
                    <div className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto]">
                      {footerServices.map((service, index) => (
                        ...
                        >
                          ...
                          {service.link ? (
                            <a
                              className="w-fit font-medium text-base tracking-[0.32px] leading-[normal] relative mt-[-1.00px] [font-family:'Poppins',Helvetica] text-[#05213c]"
                              href={service.link}
                            ...
                            <div className="w-fit font-medium text-base tracking-[0.32px] leading-[normal] relative mt-[-1.00px] [font-family:'Poppins',Helvetica] text-[#05213c]">
                              {service.name}
                            </div>
                          )}
                        </div>
                  ...
                  <div className="inline-flex flex-col h-[181px] items-start gap-5 relative">
                  ...
                  <div className="flex-col h-[325px] items-start gap-5 inline-flex relative">
                    <div className="relative w-fit mt-[-1.00px] [font-family:'Poppins',Helvetica] font-semibold text-[#303030] text-[22px] tracking-[0] leading-[28.6px] whitespace-nowrap">
                      Contact &amp; Legal
                    </div>
                    ...
                    <div className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto]">
                      ...
                      <div className="inline-flex items-center justify-center gap-1.5 relative flex-[0_0_auto]">
                        ...
                        <div className="relative w-fit mt-[-1.00px] [font-family:'Poppins',Helvetica] font-medium text-[#303030] text-base tracking-[0.32px] leading-[normal]">
                          Urgențe: 0744-579-725
                        </div>
                      </div>

                      <div className="items-center justify-center gap-1.5 flex-[0_0_auto] inline-flex relative">
                        <div className="relative w-5 h-5">
                          <img
                      ...
                      {footerLegal.map((item, index) => (
                        <div
                          key={index}
                          className="items-center justify-center gap-1.5 flex-[0_0_auto] inline-flex relative"
                        >
                          <div className="relative w-[18px] h-[18px]">
                            <img
                              className="absolute w-[15px] h-[15px] top-0.5 left-0.5"
            ...
            {screenWidth >= 1440 && (
              <>
                <div className="flex-col h-56 items-start inline-flex relative flex-[0_0_auto]">
                  <div className="relative w-[196px] h-9">
                    <div className="relative h-[35px] left-px bg-[url(/img/wordmark-9.svg)] bg-[100%_100%]">
                      <img
                        className="absolute w-[35px] h-[35px] top-0 left-[37px]"
                        alt="Vector"
                  ...
                  <div className="flex-col items-start gap-3 self-stretch w-full flex-[0_0_auto] flex relative">
                    <div className="items-center justify-center gap-1.5 px-0 py-5 inline-flex relative flex-[0_0_auto]">
                      <p className="w-[340px] font-medium text-base tracking-[0.32px] leading-[normal] relative mt-[-1.00px] [font-family:'Poppins',Helvetica] text-[#05213c]">
                        Instalații gaze și centrale termice
                        <br />
                        Fondat 1996 | Autorizat ANRE și ISCIR
                ...
                <div className="flex flex-col w-[293px] h-[315px] items-start gap-5 relative">
                  ...
                  <div className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto]">
                    {footerServices.map((service, index) => (
                      <div
                        key={index}
                        className="items-center justify-center gap-1.5 inline-flex relative flex-[0_0_auto]"
                      >
                        <div className="relative w-[18px] h-[18px]">
                          <img
                            className="absolute w-[15px] h-[15px] top-0.5 left-0.5"
                ...
                <div className="inline-flex flex-col h-[315px] items-start gap-5 relative flex-[0_0_auto]">
                  <div className="relative w-fit mt-[-1.00px] [font-family:'Poppins',Helvetica] font-semibold text-[#303030] text-[22px] tracking-[0] leading-[28.6px] whitespace-nowrap">
                    Zone Deservite
                  </div>
                  ...
                  <div className="flex flex-col w-[293px] items-start gap-3 relative flex-[0_0_auto]">
                    {footerAreas.map((area, index) => (
                      <div
                        key={index}
                        className={`${index < 2 ? "inline-flex" : "flex self-stretch w-full"} items-center gap-1.5 relative ${index < 2 ? "flex-[0_0_auto]" : "flex-[0_0_auto]"}`}
                      >
                        <div className="relative w-[18px] h-[18px]">
                          <img
                            className="absolute w-[15px] h-[15px] top-0.5 left-0.5"
                        ...
                        <div
                          className={`relative ${index < 2 ? "w-fit" : "flex-1"} mt-[-1.00px] [font-family:'Poppins',Helvetica] font-medium text-[#303030] text-base tracking-[0.32px] leading-[normal]`}
                        >
                          {area}
                        </div>
                      </div>
                ...
                <div className="flex-col h-[366px] items-start gap-5 mr-[-3.00px] inline-flex relative flex-[0_0_auto]">
                  <div className="relative w-fit mt-[-1.00px] [font-family:'Poppins',Helvetica] font-semibold text-[#303030] text-[22px] tracking-[0] leading-[28.6px] whitespace-nowrap">
                    Contact &amp; Legal
                  </div>

                  <div className="inline-flex flex-col items-start gap-3 relative flex-[0_0_auto]">
                    <div className="items-center justify-center gap-1.5 inline-flex relative flex-[0_0_auto]">
                      <div className="relative w-5 h-5">
                        <img
                          className="absolute w-[15px] h-[18px] top-px left-[3px]"
                          alt="Vector"
                      ...
                      <div
                        className="relative w-fit mt-[-1.00px] [font-family:'P
oppins',Helvetica] font-medium text-[#05213c] text-base tracking-[0.32px] leading-[normal]"
                      >
                        Constanța, România
                      </div>
                    </div>
                    ...
                    <div className="inline-flex items-center justify-center gap-1.5 relative flex-[0_0_auto]">
                      <div className="relative w-5 h-5">
                        <img
                          className="absolute w-[18px] h-[15px] top-[3px] left-px"
                          alt="Vector"
                          src="/img/vector-113.svg"
                        />
                      </div>

                      <a
                        className="relative w-[213px] mt-[-1.00px] [font-family:'Poppins',Helvetica] font-medium text-[#303030] text-base tracking-[0.32px] leading-[normal] underline"
                        href="mailto:contact@conest-gaze-centrale.ro"
                        rel="noopener noreferrer"
                        target="_blank"
                      >
          ...
          <div
            className={`[font-family:'Poppins',Helvetica] tracking-[0] text-base text-[#5a5a5a] h-[107px] font-normal text-center leading-[28.8px] relative ${screenWidth >= 1440 ? "w-[1395px]" : ""} ${screenWidth >= 977 && screenWidth < 1440 ? "self-stretch" : ""} ${screenWidth >= 1440 ? "mr-[-77.50px]" : ""} ${screenWidth >= 1440 ? "ml-[-77.50px]" : ""} ${screenWidth >= 977 && screenWidth < 1440 ? "mb-[-19.00px]" : ""}`}
          >
            {screenWidth >= 977 && screenWidth < 1440 && (
              <p>
                © 2025 CON EST IMPEX SRL. Toate drepturile rezervate. |
                Instalații gaze și centrale termice Constanța din 1996 Autorizat
                ANRE • Certificat ISCIR (RVT și RSL) • Conform standardelor
                europene
              </p>
            )}
            ...
            {screenWidth >= 1440 && (
              <p>
                © 2025 CON EST IMPEX SRL. Toate drepturile rezervate. |
                Instalații gaze și centrale termice Constanța din 1996
                <br />
