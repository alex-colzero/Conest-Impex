...
import { FormFieldSection } from "./sections/FormFieldSection/FormFieldSection";
import { FrequentlyAskedQuestionsSection } from "./sections/FrequentlyAskedQuestionsSection/FrequentlyAskedQuestionsSection";
import { InputFieldSection } from "./sections/InputFieldSection/InputFieldSection";
import { MainContentSection } from "./sections/MainContentSection/MainContentSection";
import { RecentPostsSection } from "./sections/RecentPostsSection/RecentPostsSection";
...
export const ElementContentPage = () => {
  const screenWidth = useWindowWidth();
  const [menuOpen, setMenuOpen] = useState(false);

  return (
    <div
      className="flex flex-col items-center relative bg-[#f3f2ef]"
      data-model-id="357:11267"
    >
      {/* Navigation Header - Same as Homepage */}
      <header
        className="w-full flex items-center max-w-[1920px] px-5 sm:px-10 lg:px-[50px] py-[30px] justify-between relative bg-[#f5f4f1] min-h-[90px]"
      >
      ...
      <div className="relative self-stretch w-full h-[754px] shadow-[0px_1px_1px_#303030] bg-[url(/img/hero-1.png)] bg-cover bg-[50%_50%]" />
