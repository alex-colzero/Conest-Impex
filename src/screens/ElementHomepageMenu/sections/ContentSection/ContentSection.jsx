...
export const ContentSection = () => {
  ...
  return (
    <section className="flex flex-col max-w-[1600px] items-center gap-10 px-5 py-[100px] relative w-full flex-[0_0_auto]">
      ...
      <div className="flex flex-col items-start gap-[30px_30px] pt-[70px] pb-0 px-0 relative self-stretch w-full flex-[0_0_auto]">
        {services.map((service) => (
          ...
          >
            <div className="flex items-center gap-10 relative flex-1 grow">
              <article className="flex flex-col h-[508px] items-center pt-[60px] pb-[50px] px-10 relative flex-1 grow bg-white rounded-[40px]">
                ...
                <div className="inline-flex flex-col items-center justify-end gap-2.5 relative flex-1 grow">
                  <div className="inline-flex flex-col items-center justify-end gap-2.5 relative flex-[0_0_auto]">
                    <button
                      className="all-[unset] box-border flex w-[294px] h-[70px] items-center px-9 py-[30px] bg-[#05213c] justify-center relative rounded-[10px] overflow-hidden hover:bg-[#0a2a4a] focus:bg-[#0a2a4a] focus:outline-2 focus:outline-offset-2 focus:outline-[#05213c] transition-colors duration-200"
                      type="button"
